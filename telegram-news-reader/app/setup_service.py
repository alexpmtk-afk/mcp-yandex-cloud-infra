...
_PAGE = """<!doctype html><meta charset='utf-8'><title>Telegram Reader Setup</title><body><h1>Telegram Reader Setup</h1><p>Use the setup API to authorize Telegram and select allowed chats.</p></body>"""
